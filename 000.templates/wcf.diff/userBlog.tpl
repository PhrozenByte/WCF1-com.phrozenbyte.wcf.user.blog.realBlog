				...
				<div class="container-1 column first">
					<div class="columnInner">
						<div class="contentBox">
							<h3 class="subHeadline">{if $tagID}{lang}wcf.user.blog.entries.tagged{/lang}{elseif $categoryID}{lang}wcf.user.blog.category.entries{/lang}{else if $filter == 'archive'}{lang}wcf.user.blog.archive.entries{/lang}{else}{lang}wcf.user.blog{/lang}{/if} <span>({#$items})</span></h3>
										...
										<div class="messageInner {cycle values='container-1,container-2'}">
											...
											<div class="messageHeader">
												...
												<div class="containerIconLarge">
													{if $user->getAvatar()}
														{assign var=x value=$user->getAvatar()->setMaxSize(48, 48)}
